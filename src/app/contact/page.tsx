        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          ...
          <div className="grid md:grid-cols-2 gap-12">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    required
                    rows={5}
                    className="bg-[#0c2340]/70 border-white/10 text-white resize-none"
                  />
                </div>
            ...
            <div>
              ...
              <div className="space-y-8">
                <div className="flex items-start">
                  <div className="bg-yellow-500 p-3 rounded-lg mr-4">
                    <MapPin className="h-6 w-6 text-[#0a1a2e]" />
                  </div>
                  <div>
                ...
                <div className="flex items-start">
                  <div className="bg-yellow-500 p-3 rounded-lg mr-4">
                    <Mail className="h-6 w-6 text-[#0a1a2e]" />
                  </div>
                  <div>
                ...
                <div className="flex items-start">
                  <div className="bg-yellow-500 p-3 rounded-lg mr-4">
                    <Phone className="h-6 w-6 text-[#0a1a2e]" />
                  </div>
                  <div>
              ...
              <div className="mt-12 bg-[#0c2340]/50 border border-white/10 rounded-lg p-6">
                <h3 className="text-white font-medium text-lg mb-4">Follow Us</h3>
                <div className="flex space-x-4">
                  <a href="#" className="bg-yellow-500 p-2 rounded-full hover:bg-yellow-600 transition-colors">
                    <svg className="h-5 w-5 text-[#0a1a2e]" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      <path
                        fillRule="evenodd"
