...
const plans = [
  {
    name: "Monthly",
    price: 2399, // ~$19.99 in KES
    period: "month",
    features: [
      "Access to exclusive designs",
      "Free shipping on orders over KES 6,000",
  ...
  {
    name: "Annual",
    price: 1799, // ~$14.99 in KES
    period: "month",
    billedAs: "billed annually (KES 21,588)",
    features: [
  ...
  return (
    <div className="min-h-screen bg-[#0a1a2e] antialiased bg-grid-white/[0.02] relative">
      ...
      <div className="relative z-10 container mx-auto px-4 py-12">
        ...
        >
          <div className="inline-block bg-gradient-to-r from-yellow-400 to-yellow-600 p-2 rounded-full mb-4">
            <Crown className="h-8 w-8 text-[#0a1a2e]" />
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-20">
              ...
              {benefits.map((benefit, index) => (
                <div key={index} className="flex items-center">
                  <div className="bg-yellow-500 rounded-full p-1 mr-3">
                    <Check className="h-4 w-4 text-[#0a1a2e]" />
                  </div>
          ...
          <motion.div
            ...
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.5, delay: 0.2 }}
            className="bg-[#0c2340]/50 border border-white/10 rounded-lg p-6"
          >
            ...
            >
              <Card
                className={`relative h-full ${
                  plan.popular
                    ? "bg-gradient-to-b from-[#0c2340]/80 to-[#0a1a2e]/80 border-yellow-500"
                    : "bg-[#0c2340]/50 border-white/10"
                }`}
              >
                {plan.popular && (
                  <div className="absolute top-0 right-0 bg-yellow-500 text-[#0a1a2e] text-xs px-3 py-1 rounded-bl-lg rounded-tr-lg font-semibold">
                    Most Popular
                  </div>
                )}
                <CardHeader>
                ...
                <CardFooter>
                  <Button
                    className={`w-full ${
                      plan.popular
                        ? "bg-yellow-500 hover:bg-yellow-600 text-[#0a1a2e] font-semibold"
        ...
        <div className="text-center">
          ...
          <Button size="lg" className="bg-yellow-500 hover:bg-yellow-600 text-[#0a1a2e] font-semibold px-8">
            Become a Member
          </Button>
        </div>
      </div>
