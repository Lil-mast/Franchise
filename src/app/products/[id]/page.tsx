      ...
      <div className="min-h-screen bg-[#0a1a2e] flex items-center justify-center">
        <div className="text-center">
          ...
          <Button
            ...
            className="bg-yellow-500 hover:bg-yellow-600 text-[#0a1a2e] font-semibold"
          >
            Back to Products
          </Button>
        </div>
      ...
      <div className="relative z-10 container mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5 }}>
            <div className="relative h-[400px] md:h-[500px] w-full rounded-lg overflow-hidden bg-[#0c2340]/50 border border-white/10">
              <Image
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5 }}>
            ...
            <p className="text-2xl text-yellow-400 font-bold mt-2">{formatCurrency(product.price)}</p>
            ...
            <div className="mt-8 space-y-6">
              ...
              <div>
                ...
                <Select value={selectedSize} onValueChange={setSelectedSize}>
                  <SelectTrigger className="bg-[#0c2340]/50 border-white/10 text-white w-full">
                    <SelectValue placeholder="Select size" />
                  </SelectTrigger>
                  <SelectContent className="bg-[#0c2340]/90 border-white/10 text-white">
