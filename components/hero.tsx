...
export default function Hero() {
  return (
    <div className="relative min-h-[calc(100vh-76px)] flex items-center pb-32">
      ...
      <motion.div
        ...
        className="absolute bottom-10 left-0 right-0 mx-auto max-w-4xl bg-[#0c2340]/80 backdrop-blur-md p-6 rounded-lg border border-white/10"
      >
